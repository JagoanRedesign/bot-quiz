...
define('TOKEN','5620851513:AAGsm0rFSLw_ZR_4dsHL3-KYIWaoFnV07-I');
$developer = '5166575484'; // set ID Developer
$botname = "Quizarena_bot";
	...
	foreach ($updates as $message){
		...
		if (isset($message_data['new_chat_member'])) {
			if($message_data['new_chat_member']['username'] == $botname){
				$output="Halo semuanya, saya adalah pembawa acara Quiz Arena.\n";
...
Anda juga bisa mengikuti public group t.me/KuisMayoritas";
			...
			elseif($jenis == "group" and substr($text,0,1) == "/"){ 
				...
				if($text == "/rule"){
					$output = "Skor untuk jawaban anda adalah jumlah orang lain yang jawabannya sama dengan anda dikali 10. t.me/familyEbook/4";
					$data = array(
								'chat_id' => $chatid,
								'text'=> $output,
								'parse_mode'=>'Markdown',
